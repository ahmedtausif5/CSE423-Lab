...
public class Lab04 implements GLEventListener{
   ...
   public void display(GLAutoDrawable drawable) {
      ...
      //DRAWING 6
      Midpoint_Circle(gl,0,50,10);
      Midpoint_Circle(gl,10,50,10);
      Midpoint_Circle(gl,20,50,10);
      Midpoint_Circle(gl,30,50,10);
      Midpoint_Circle(gl,40,50,10);
      Midpoint_Circle(gl,50,50,10);
      Midpoint_Circle(gl,40,40,10);
      Midpoint_Circle(gl,30,30,10);
      Midpoint_Circle(gl,20,20,10);
      Midpoint_Circle(gl,10,10,10);
      Midpoint_Circle(gl,0,0,10);
